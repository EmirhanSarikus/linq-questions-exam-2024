...
{   
    public static void ClearDB(ExamContext db) {
           string dropTables = @"
                    ...
                    ";
           db.Database.ExecuteSqlRaw(dropTables);         
    }
    ...
    public static List<FoodItem> GetFoodItems()
    {
        List<FoodItem> foodItems = new List<FoodItem>(){
            ...
            new FoodItem(7, "Spinach Samosa", 11, 3.25m, "100g"),
            ...
            new FoodItem(11, "Spinach", 4, 3.5m),
            new FoodItem(12, "Aubergine and Spinach", 4, 9.50m),
            new FoodItem(13, "Broccoli with Spinach", 4, 8m),
    ...
    {   
        //if using VisualStudio use this code instead (on next line): 
        //File.ReadAllLines(Environment.ProcessPath.Split("bin")[0]+"Customers.csv")
        return File.ReadAllLines("./Customers.csv")  
                   .Skip(1) //Header
                   .Where(_ => _.Length > 0)
